...
const Home = () => {
  return (
    <div 
      className="bg-cover bg-center min-h-screen font-sans text-gray-800" 
      style={{ 
    ...
    >
      ...
      <section className="text-center py-20 px-6 relative z-10">
        ...
        >
          Welcome to <span className="text-white underline">HotelManager</span>
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0 }} 
          animate={{ opacity: 1 }} 
          transition={{ delay: 0.4 }}
          className="text-lg max-w-2xl mx-auto mb-8 text-white"
        >
        ...
        >
          <Link to="/signup">
            <button className="bg-white text-teal-900 font-semibold px-6 py-3 rounded-xl shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
          <Link to="learn-more">
            <button className="border-2 border-white text-white px-6 py-3 rounded-xl hover:bg-white hover:text-green-600 transition duration-300">
              Learn More
            </button>
          </Link>
        </motion.div>
